    ...
    <div class="container">
        <div class="sidebar">
            ...
            <div class="sidebar-buttons">
                <button class="sidebar-btn"><a href="ownerorders.php" style="text-decoration: none; color: inherit;">Orders</a></button>
        ...
        <div class="content">
            ...
            <div class="orders-list">
                <!-- Filter Buttons -->
                <div class="order-top">
                    <button class="orderlist-btns"><a href="ownerorders.php?status=Pending" style="text-decoration: none; color: inherit;">Pending</a></button>
                    <button class="orderlist-btns"><a href="ownerorders.php?status=Completed" style="text-decoration: none; color: inherit;">Completed</a></button>
                </div>
                            ...
                            while ($order = $result_orders->fetch_assoc()) {
                                ...
                                <li class="orderlist-ele">
                                    <div>
                                        ...
                                        <p>Contact: <label for="">Not Provided</label></p>
                                    ...
                                    <div>
                                        <p style="padding-bottom:0.5rem;">Order status: <label for=""><?php echo htmlspecialchars($order['status']); ?></label></p>
                                    </div>
